          !Este programa calcula la integral con la regla de 1/3 simpson de la función x=(1200v)dv/(8v**2+1000) de 0 a 30
          integer nsub
          dimension x(0:30),fx(0:30)
          open(1, file='si2.dat',status='old')
          n=30
           do i=0,n
            read (1,*) x(i),fx(i)
           enddo
           ...
           do k=1,nsub
            ...
            f2=fx(2*k)
             call cuadratica1(x0,x1,x2,f0,f1,f2,a,b,c)
              ...
              print *, k,suma
           enddo
           print *,'la integral de 0 a 30 es' , suma
          end
